...
public class DeclarativeModuleTest extends ModuleTest
{
  ...
  /**
   * test exact match searching. searching using strings, numbers, boolean,
   * and chunks
   * @throws Exception
   */
  @Test
  ...
  static public IChunk createChunk(IDeclarativeModule module, String name, IChunkType type, Object ... slotsAndValues) throws Exception
  {
    ...
    {
      BasicSlot slot = new BasicSlot(slotsAndValues[i].toString(), slotsAndValues[i+1]);
  ...
  static public IChunkType createChunkType(IDeclarativeModule module, String name, IChunkType parent, String ... slots) throws Exception
  {
