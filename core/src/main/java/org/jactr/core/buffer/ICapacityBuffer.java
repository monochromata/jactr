...
{
  static public final String EJECTION_POLICY_PARAM = "EjectionPolicy";

  static public enum EjectionPolicy {
    LeastRecentlyUsed, LeastRecentlyMatched, LeastRecentlyAdded, MostRecentlyUsed, MostRecentlyMatched, MostRecentlyAdded
  };
