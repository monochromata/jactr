...
/**
 * Denotes an illegal state of the model : ex: attempt to set a retrieval
...
public class IllegalModelStateException extends IllegalStateException
{
   ...
   * 
   */
  private static final long serialVersionUID = 1935630845055257776L;
  ...
  public IllegalModelStateException(String message, Throwable thrown)
  {
    this(message);
    initCause(thrown);
  }
