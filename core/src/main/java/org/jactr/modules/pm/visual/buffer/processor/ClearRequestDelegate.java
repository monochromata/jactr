...
public class ClearRequestDelegate extends AbstractRequestDelegate
{
  ...
  protected Object startRequest(IRequest request, IActivationBuffer buffer,
      double requestTime)
  {
    IVisualActivationBuffer actBuffer = (IVisualActivationBuffer) buffer;
    IVisualLocationBuffer locBuffer = ((IVisualModule) actBuffer.getModule())
  ...
  protected void finishRequest(IRequest request, IActivationBuffer buffer,
      Object startValue)
  {
    ((IVisualModule) buffer.getModule()).reset(isFullReset(request));
  }
